...
module.exports = class UniCrypto {
  ...
  aesEncode(data, encodeReturnType, key, iv, mod, charset) {
    const cipher = crypto.createCipheriv(mod || this.config.AES.mod, key || this.config.AES.pasword, iv || this.config.AES.iv);
  ...
  aesDecode(crypted, encodeReturnType, key, iv, mod, charset) {
    ...
    const decipher = crypto.createDecipheriv(mod || this.config.AES.mod, key || this.config.AES.pasword, iv || this.config.AES.iv);
