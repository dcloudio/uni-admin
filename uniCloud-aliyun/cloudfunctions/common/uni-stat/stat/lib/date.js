  ...
  getTimeDimensionByType(type, offset = 0, thistime, getAll = false) {
    ...
    switch (type) {
      ...
      case 'month': {
        ...
        endTime = getAll ? nextMonthFirstDayTime - 86400000 : this.getTimeByDateAndTimezone(nextMonthFirstDayTime) - 1;
        break;
      }
      case 'quarter': {
      ...
      case 'year': {
        ...
        endTime = getAll ? nextFirstDayTime - 86400000 : this.getTimeByDateAndTimezone(nextFirstDayTime) - 1;
        break;
      }
    }
    return {
