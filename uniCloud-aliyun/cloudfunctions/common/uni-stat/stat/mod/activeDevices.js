...
module.exports = class ActiveDevices extends BaseMod {
  ...
  async getFillData(data) {
    ...
    if (data.device_ids) {
      ...
      const haveWeekList = await this.selectAll(
        this.tableName,
        {
          appid: data.appid,
      ...
      const haveMonthList = await this.selectAll(
        this.tableName,
        {
          appid: data.appid,
          version_id: versionInfo._id,
    ...
    if (data.old_device_ids) {
      ...
      const haveOldWeekList = await this.selectAll(
        this.tableName,
        {
          appid: data.appid,
          version_id: versionInfo._id,
      ...
      const haveOldMonthList = await this.selectAll(
        this.tableName,
        {
          appid: data.appid,
          version_id: versionInfo._id,
