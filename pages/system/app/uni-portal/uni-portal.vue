	...
	<view class="uni-container">
		...
		<view style="margin-top: 20rpx;">
			...
			<view class="">
				...
				<text class="text-separated">是 uni-app 提供的一套开箱即用的“统一发布页”。</text>
			</view>
			<view class="">
				<text class="strong">uni-portal </text>
				<text class="text-separated">可作为面向用户的统一业务名片，在一个页面集中展现：App下载地址、小程序二维码、H5访问链接等信息。</text>
			</view>

			<view class="">

				<!-- #ifdef H5 -->
				<text class="text-separated" style="font-size: 16px;">uni-app 官方示例的发布页就是基于<text class="strong">uni-portal </text> 制作的，<a href="https://hellouniapp.dcloud.net.cn/portal">点击体验</a>
		...
		<view style="margin-top: 20px;">
			...
			<view class="">
				<text class="text-separated">
					为了让用户访问到这个“统一发布页”，你需要将该静态HTML文件上传到你的服务器中；推荐使用<a href="https://uniapp.dcloud.io/uniCloud/hosting" target="_blank" class="a-label" style="padding: 5px;">前端网页托管</a>，因为前端网页托管具备使用更简单、价格更便宜、访问更快等优点。
				</text>
			</view>
