<template>
	<view class="uni-container">
		...
		<view style="margin-top: 20rpx;">
			...
			<view class="">
				<text class="text-separated"
					style="font-size: 16px;">你需要为自己的业务制作一个名片，名片上统一展现：App 的下载地址、小程序二维码、H5访问链接等，也就是<view class="strong">“统一发布页” </view>。</text>
			</view>

			<view class="">
				<text class="text-separated"
					style="font-size: 16px;">而你自己从头开发这么一个“统一发布页”，工作量是巨大的，因为你需要兼容pc/mobile，你需要自动识别浏览器环境等。</text>
			</view>

			<view class="">
				<text class="text-separated">
					<view class="strong">uni-portal </view> 是 uni-app 提供的一套开箱即用的“统一发布页”，它可以帮你实现：</text>
			</view>
			...
			<view class="">
				...
				<!-- #ifdef H5 -->
				<text class="text-separated" style="font-size: 16px;">uni-app 官方示例的发布页就是基于uni-portal制作的，<a
						href="https://hellouniapp.dcloud.net.cn/portal">快速体验</a>
		...
		<view style="margin-top: 20rpx;">
			<view class="flex-center-r">
				<text class="text-separated" style="font-size: 14px;">步骤2下载的“统一发布页”，是静态HTML页面，你可以直接在本地浏览器中打开访问。</text>
			...
			<view class="flex-center-r">
				<text class="text-separated" style="font-size: 14px;">
					但我们更推荐你将该静态HTML上传到<a href="https://uniapp.dcloud.io/uniCloud/hosting" target="_blank" class="a-label">前端网页托管</a>中，因为前端网页托管提供了如下优势服务：
				</text>
			</view>
			...
			<ul style="font-size: 15px;">
				...
				<li class="text-separated">更省心：无需再购买虚拟机、安装操作系统、配置web服务器、处理负载均衡、处理大并发、处理DDoS攻击......您什么都不用管，只需上传您写的页面文件</li>
		...
		<view style="margin-top: 20rpx;">
			...
			<ul style="font-size: 15px;">
				...
				<li class="text-separated">如果遇到静态页面打开图片或者二维码不显示的情况，请在 <a href="https://unicloud.dcloud.net.cn/login" class="a-label">uniCloud Web 控制台</a>
					配置跨域设置。
				</li>
			</ul>
		</view>
