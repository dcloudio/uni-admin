	...
	<view class="fix-top-window">
		...
		<view class="uni-container">
			...
			<view class="uni-stat--sum-x mb-m">
				<view v-for="(item, index) in sumData" class="uni-stat--sum-item">
					<view class="uni-stat--sum-item-title" key="index">
						{{item.title}}
						<span v-if="item.title" class="uni-icons-help"></span>
					</view>
					<view class="uni-stat--sum-item-today" key="index">{{item.today}}</view>
					<view class="uni-stat--sum-item-yesterday" key="index">{{item.yesterday}}</view>
				</view>
			</view>
