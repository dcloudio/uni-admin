<template>
	<toolbarTool type="dropdown" @change="change" :items="items" default-val="17px" :active="active" :disabled="disabled" :tooltip="{content: '字号'}" popup-style="width: 140px;">
		<view>{{ activeText }}<text style="font-size: 13px;">px</text></view>
	</toolbarTool>
</template>
